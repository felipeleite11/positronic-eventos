			...
			<Accordion type="multiple" className="w-full">
				<AccordionItem value="tournaments">
					...
					<AccordionContent className="px-3 pb-2 pl-7">
						<ul>
							<li>
								<Link href="/meetup/add" className="p-2 rounded-md hover:bg-white/10 flex gap-2 items-center">
									<Plus size={16} />
									Cadastrar um evento
								</Link>
							</li>
							...
							<li>
								<Link href="/meetup/search" className="p-2 rounded-md hover:bg-white/10 flex gap-2 items-center">
									<Search size={16} />
									Buscar eventos
								</Link>
							</li>
