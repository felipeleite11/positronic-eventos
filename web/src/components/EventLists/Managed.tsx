...
export default function ManagedEvents({ meetups }: EventListProps) {
	...
	return (
		<>
			<p className="mx-5 text-slate-700 dark:text-slate-200 text-sm">Aqui você verá todos os eventos que criou ou administra.</p>
