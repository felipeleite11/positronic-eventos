...
class RestrictionController {
	async index(req: Request, res: Response) {
		...
		const response = await Restriction.scope(scope as string || 'full').findAll()
	...
	async show(req: Request, res: Response) {
		try {
			...
			const response = await Restriction.scope(scope as string || 'full').findByPk(req.params.id)
	...
	async create(req: Request, res: Response) {
		try {
			const response = await Restriction.create(req.body)
	...
	async update(req: Request, res: Response) {
		try {
			const item = await Restriction.scope('full').findByPk(req.params.id)
